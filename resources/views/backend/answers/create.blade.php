...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-center mb-4">
		<h1 class="h3 mb-0 text-gray-800">Answer Create Form</h1>
	</div>
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<form action="{{route('answers.store')}}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<input type="text" name="answer1" class="form-control col-sm-6" >
					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<input type="text" name="answer2" class="form-control col-sm-6" >
					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<input type="text" name="answer3" class="form-control col-sm-6" >
					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<input type="text" name="answer4" class="form-control col-sm-6" >
					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<input type="text" name="rightanswer" class="form-control col-sm-6" >
