...
<section class="blog_part section_padding">
  <div class="container col-md-12" id="answer">
    ...
    <div style="text-align: center;" class="mt-3">
      <button class="btn btnsend btn_1">Show Record</button>
    </div>
      ...
      <div class="card col-md-6 offset-md-3  " width="100px" >
        ...
        <div class="card-body">
          ...
          <div style="text-align: center;">
            <a href="{{route('titlepage')}}" class="btn btn_1  " style="box-shadow: 5px 5px #E4DFDE;">Try Again</a>

            <a class="btn btn_1" style="box-shadow: 5px 5px #E4DFDE;">Save Record</a>
          </div>
        </div>
